...
function PagosContent() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* ════════════════════════════════════════════════════════════════ */}
      {activeTab === 'pagos' && (
        <PagosDashboard empleadorId={empleadorId} onOpenAgent={() => setShowPoppinsAgent(true)} />
      )}
        ...
        <div className="max-w-2xl mx-auto p-8">
          <div className="rounded-xl border border-red-200 bg-red-50 p-6">
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a href="/hogar" className="px-4 py-2 bg-zinc-200 text-zinc-700 rounded-lg text-sm hover:bg-zinc-300">
                Volver al Dashboard
              </a>
            </div>
          </div>
