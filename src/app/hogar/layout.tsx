...
function SidebarContent({ pathname, onNavigate }: { pathname: string; onNavigate?: () => void }) {
  ...
  return (
    <div className="flex h-full flex-col">
      <div className="mb-6">
        <Link href="/hogar" className="text-xl font-bold text-zinc-900" onClick={onNavigate}>
          Poppins
        </Link>
        <p className="text-xs text-zinc-500">La magia en tu casa</p>
      </div>
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main id="main-content" className="flex-1 overflow-y-auto bg-white p-4 sm:p-6 lg:p-8 pb-20 lg:pb-8">
          <SuscripcionBanner />
          {children}
        </main>
      </div>
